...
#  */
define ["globals", "ui", "core/league", "lib/jquery", "util/bbgmView", "util/helpers", "util/viewHelpers"], (g, ui, league, $, bbgmView, helpers, viewHelpers) ->
    "use strict"
    ...
    post = (req) ->
        ...
        league.export_ objectStores, (data) ->
            json = JSON.stringify(data, undefined, 2)
            blob = new Blob([json], {type: "application/json"})
            url = window.URL.createObjectURL(blob)
            fileName = if data.meta? then data.meta.name else "League"
    ...
    updateExportLeague = (inputs, updateEvents, vm) ->
